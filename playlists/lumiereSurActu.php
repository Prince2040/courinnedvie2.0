<?php
include('../scripts/get_playlists/get_eclairageActu.php');
            ...
            <div class="col-md-12">
                <div class="page-banner">
                    <div class="page-title">
                        <h2>Lumière sur l' actu</h2>
                    </div>
                    <div class="page-breadcrumb">
                        <p><a href='index-2.html'>Vos Emissions </a> / Lumière sur l' actu </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($videos_eclairageSurActu_data) && $i < 4; $i++) {
                    ...
                    ?>
                        ...
                        <div class="single-video">
                            ...
                            <div class="video-content">
                                <h4><a class='video-title' href='../directs.php?id=<?= $videos_eclairageSurActu_data[$i]['id'] ?>'><?= $videos_eclairageSurActu_data[$i]['title'] ?></a></h4>
                                <div class="video-counter">
                                    <div class="video-viewers">
                                        <span class="fa fa-eye view-icon"></span>
                                        <span><?= $videos_eclairageSurActu_data[$i]['viewCount'] ?></span>
                                    </div>
                                    <div class="video-feedback">
                                        <div class="video-like-counter">
                                            <span class="far fa-thumbs-up like-icon"></span>
                                            <span><?= $videos_eclairageSurActu_data[$i]['likeCount'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($videos_eclairageSurActu_data) && $i < 30; $i++) {
            ?>
