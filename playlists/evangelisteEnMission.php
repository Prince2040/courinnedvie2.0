            ...
            <div class="col-md-12">
                <div class="page-banner">
                    <div class="page-title">
                        <h2>Evangeliste En Mission</h2>
                    </div>
                    <div class="page-breadcrumb">
                        <p><a href='index-2.html'>Vos Emissions </a> / Evangeliste En Mission </p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="single-video">
                            <div class="video-img">
                                <a href='../directs.php?id=<?= $videos_evangelistEnMission_data[$i]['id'] ?>'>
                                    <img class="lazy" data-src="https://img.youtube.com/vi/<?= $videos_evangelistEnMission_data[$i]['id'] ?>/hqdefault.jpg" alt="Video" />
                                </a>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($videos_evangelistEnMission_data) && $i < 30; $i++) {
