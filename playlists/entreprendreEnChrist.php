<?php
include('../scripts/get_playlists/get_entreprendreEnChrist.php');
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($videos_EntreprendreEnChrist_data) && $i < 4; $i++) {
                    ?>

                        <div class="single-video">
                            <div class="video-img">
                                <a href='../directs.php?id=<?= $videos_EntreprendreEnChrist_data[$i]['id'] ?>'>
                                    <img class="lazy" data-src="https://img.youtube.com/vi/<?= $videos_EntreprendreEnChrist_data[$i]['id'] ?>/hqdefault.jpg" alt="Video" />
                                </a>
                                <span class="video-duration">3.11</span>
                            </div>
                            <div class="video-content">
                                <h4><a class='video-title' href='../directs.php?id=<?= $videos_EntreprendreEnChrist_data[$i]['id'] ?>'><?= $videos_EntreprendreEnChrist_data[$i]['title'] ?></a></h4>
                                <div class="video-counter">
                                    <div class="video-viewers">
                                        <span class="fa fa-eye view-icon"></span>
                                        <span><?= $videos_EntreprendreEnChrist_data[$i]['viewCount'] ?></span>
                                    </div>
                                    <div class="video-feedback">
                                        <div class="video-like-counter">
                                            <span class="far fa-thumbs-up like-icon"></span>
                                            <span><?=  $videos_EntreprendreEnChrist_data[$i]['likeCount'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($videos_EntreprendreEnChrist_data) && $i < 30; $i++) {
            ?>
