...
//var_dump($videos_AinsiParleEternel_data) ;
//exit ;
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($videos_AinsiParleEternel_data) && $i < 4; $i++) {
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($videos_AinsiParleEternel_data) && $i < 30; $i++) {
            ?>
