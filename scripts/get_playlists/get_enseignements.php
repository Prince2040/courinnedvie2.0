<?php
    ...
    if (file_exists($cacheFile) && time() - filemtime($cacheFile) < $cacheTime) {
        ...
        $videos_enseignement_data = json_decode(file_get_contents($cacheFile), true);
    } else {
        ...
        if ($response) {
            ...
            $data_enseignement = json_decode($response, true);

            $videos_enseignement = $data_enseignement['items'];

            $videos_enseignement_data = [];
    
    
            foreach ($videos_enseignement as $video) {
               ...
               /*echo  "<pre>" ;
                ...
                $videos_enseignement_data[] = $video_enseignement_data;
    
                //$videos_data[] = $video_data;
            }
    
            // Enregistrer les données dans un fichier JSON
            file_put_contents($cacheFile, json_encode($videos_enseignement_data));
