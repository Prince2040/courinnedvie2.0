                                ...
                                <div class="main-nav rightnav">
                                    ...
                                    <div id="menu" class="collapse header-menu">
                                        <ul class="nav themeix-nav">
                                            ...
                                            <li><a href='bible/genese.php' title='bile'>Bible</a></li>                                                                        
                                                ...
                                                <ul>
                                                    ...
                                                    <li><span class="subtitle">Marche avec Christ</span> <span class="arrow"></span>
                                                        <ul class="mega-list">
                                                            ...
                                                            <li><a href='playlists/evenements.php'><i class="fa fa-angle-right"></i>Evènements</a></li>
                                                            <li><a href='playlists/gospelOnFire.php'><i class="fa fa-angle-right"></i>Gospel On Fire</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
