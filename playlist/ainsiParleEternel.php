<?php
include('scripts/get_ainsiParleEternel.php');
            ...
            <div class="col-md-12">
                <div class="page-banner">
                    ...
                    <div class="page-breadcrumb">
                        <p><a href='index-2.html'>Vos Emissions </a> / Ainsi Parle L'Eternel</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($data_AinsiParleEternel['items']) && $i < 4; $i++) {

                        $item = $data_AinsiParleEternel['items'][$i];
                    ?>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($data_AinsiParleEternel['items']) && $i < 30; $i++) {
