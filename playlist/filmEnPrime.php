<?php
include('scripts/get_filmEnPrime.php');
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($data_filmEnPrime['items']) && $i < 4; $i++) {

                        $item = $data_filmEnPrime['items'][$i];
                    ?>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($data_filmEnPrime['items']) && $i < 30; $i++) {
