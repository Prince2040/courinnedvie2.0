<?php
include('scripts/get_femmeVousAvezParole.php');
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="video-carousel owl-carousel">
                    ...
                    <?php
                    for ($i = 0; $i < count($data_femmeVousAvezParole['items']) && $i < 4; $i++) {

                        $item = $data_femmeVousAvezParole['items'][$i];
                    ?>
...
<div class="wide-video-section themeix-ptb">
    <div class="container">
        <div class="row">
            ...
            for ($i = 0; $i < count($data_femmeVousAvezParole['items']) && $i < 30; $i++) {
